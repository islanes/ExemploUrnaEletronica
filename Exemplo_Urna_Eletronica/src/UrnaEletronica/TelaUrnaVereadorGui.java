 ...
 * @author m8
 */
public class TelaUrnaVereadorGui extends javax.swing.JFrame {
    public static String CandidatoVerificarV = null;
     //public static String CandidatoVerificarD = null;
    String P1="10", P2="20", P3="30";
    String PartidoV= null;
    String V1= "10000", V2= "20000",V3= "30000";
        //variavel  global assim a ultima tela recebe ela e ad no banco de dados
    ...
    private void initComponents() {
        ...
        setUndecorated(true);
        setPreferredSize(new java.awt.Dimension(950, 389));
        setResizable(false);
        ...
        TelaCandidatoLayout.linkSize(javax.swing.SwingConstants.HORIZONTAL, new java.awt.Component[] {jTextField1, jTextField2, jTextField3, jTextField4, jTextField5});
        ...
        TelaCandidatoLayout.linkSize(javax.swing.SwingConstants.VERTICAL, new java.awt.Component[] {jTextField1, jTextField2, jTextField3, jTextField4, jTextField5});
    ...
    private void ConfirmaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ConfirmaActionPerformed
       ...
       l3= (jTextField3.getText());
       l4= (jTextField4.getText());
       l5= (jTextField5.getText());
...
//        VereadorDao vdao = new VereadorDao();
       ...
       if(jTextField1.getText().equals(" ")){
        ...
        CandidatoVerificarV= "BRANCO";
        TelaUrnaDeputadoGui dep = new TelaUrnaDeputadoGui();
        dep.show();
        dispose();
        
    //    v.setVereador(CandidatoVerificar);
      ...
      //  v.setVereador(CandidatoVerificar);
       ...
       //concatena os valores dos campos aqui
       CandidatoVerificarV= l1.concat(l2).concat(l3).concat(l4).concat(l5);
...
//           VerificaCandidato();
    ...
    // esta variavel sera adiconada ao metodo de verificar o candidadto jLabel8.setText("NUMERO: "+CandidatoVerificar);
        if(CandidatoVerificarV.equals(V1)){
        
            jLabel4.setText("NOME: Vôlei");
            //talvez Partido tbm
            //nunca esquecer do getClass().getResource(caminho da imagem aqui)
            
            jLabel3.setIcon(new ImageIcon(getClass().getResource("Vereador/91001_volei.jpg")));
                   
        }
        else   if(CandidatoVerificarV.equals(V2)){
        
            jLabel4.setText("NOME: Rock");
            //talvez Partido tbm
            //nunca esquecer do getClass().getResource(caminho da imagem aqui)
            
            jLabel3.setIcon(new ImageIcon(getClass().getResource("Vereador/92001_rock.jpg")));
                        
        }
        else if(CandidatoVerificarV.equals(V3)){
        
            jLabel4.setText("NOME: Médica");
            //nunca esquecer do getClass().getResource(caminho da imagem aqui)
            
            jLabel3.setIcon(new ImageIcon(getClass().getResource("Vereador/93004_medica.jpg")));
                        
        }      
         else if (CandidatoVerificarV!=V1 && CandidatoVerificarV!=V2 && CandidatoVerificarV!=V3 && votonulo==false ){
    ...
    if (jTextField1.getText().equals((""))){
        jTextField1.setText(jTextField1.getText().concat(dig));}
            ...
            jTextField3.setText(jTextField3.getText().concat(dig));}
        
        else if(jTextField4.getText().equals((""))){
        jTextField4.setText(jTextField4.getText().concat(dig));}
        
            else if(jTextField5.getText().equals((""))){
            jTextField5.setText(jTextField5.getText().concat(dig));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TelaUrnaVereadorGui.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TelaUrnaVereadorGui().setVisible(true);
            }
        });
    }
