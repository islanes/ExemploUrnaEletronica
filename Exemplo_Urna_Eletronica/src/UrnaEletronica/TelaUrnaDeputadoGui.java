 ...
 * @author m8
 */
public class TelaUrnaDeputadoGui extends javax.swing.JFrame {
    public static String CandidatoVerificarD = null;
     //public static String CandidatoVerificarD = null;
    String P1="10", P2="20", P3="30";
    String PartidoV= null;
    String V1= "10011", V2= "20012",V3= "30013";
    ...
    private void ConfirmaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ConfirmaActionPerformed
       ...
       if(jTextField1.getText().equals(" ")){
        ...
        CandidatoVerificarD= "BRANCO";
        TelaUrnaPrefeitoGui pref = new TelaUrnaPrefeitoGui();
        pref.show();
        dispose();
       ...
       //concatena os valores dos campos aqui
       CandidatoVerificarD= l1.concat(l2).concat(l3).concat(l4).concat(l5);
    ...
    // esta variavel sera adiconada ao metodo de verificar o candidadto jLabel8.setText("NUMERO: "+CandidatoVerificar);
        if(CandidatoVerificarD.equals(V1)){
        
            jLabel4.setText("NOME: Basquete");
            //talvez Partido tbm
            //nunca esquecer do getClass().getResource(caminho da imagem aqui)
            
            jLabel3.setIcon(new ImageIcon(getClass().getResource("Deputado/91002_basquete.jpg")));
                   
        }
        else   if(CandidatoVerificarD.equals(V2)){
        
            jLabel4.setText("NOME: Frevo");
            //talvez Partido tbm
            //nunca esquecer do getClass().getResource(caminho da imagem aqui)
            
            jLabel3.setIcon(new ImageIcon(getClass().getResource("Deputado/92003_frevo_.jpg")));
                        
        }
        else if(CandidatoVerificarD.equals(V3)){
        
            jLabel4.setText("NOME: Enfermeira");
            //nunca esquecer do getClass().getResource(caminho da imagem aqui)
            
            jLabel3.setIcon(new ImageIcon(getClass().getResource("Deputado/93005_enfermeira.jpg")));
                        
        }      
         else if (CandidatoVerificarD!=V1 && CandidatoVerificarD!=V2 && CandidatoVerificarD!=V3 &&votonulo==false ){
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TelaUrnaDeputadoGui.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TelaUrnaDeputadoGui().setVisible(true);
            }
        });
    }
